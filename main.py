...
def parse_args():
    ...
    parser.add_argument('--input_size', type=int, default=128, help='Width / Height of input image (must be rectangular)')
    ...
    parser.add_argument('--use_visualize', action='store_true', help='visualize_pic')
    parser.add_argument('--use_tfrecord', action='store_true', help='use_tfrecord')
